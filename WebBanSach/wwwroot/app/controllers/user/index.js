var UserController = function () {
    ...
    function registerEvents() {
        ...
        $('#btnSave').on('click', function (e) {
            if ($('#frmMaintainance').valid()) {
                ...
                $.ajax({
                    ...
                    success: function () {
                        webbansach.notify('Lưu người dùng thành công', 'success');
                    ...
                    error: function () {
                        webbansach.notify('Có lỗi xảy ra khi lưu', 'error');
                        webbansach.stopLoading();
                    }
                });
            }
        ...
        $('body').on('click', '.btn-delete', function (e) {
            e.preventDefault();
            var that = $(this).data('id');
            webbansach.confirm('Bạn có muốn xóa người dùng này?', function () {
                $.ajax({
                    type: "POST",
                    ...
                    success: function () {
                        webbansach.notify('Xóa người dùng thành công', 'success');
                        webbansach.stopLoading();
                        loadData();
                    },
                    error: function () {
