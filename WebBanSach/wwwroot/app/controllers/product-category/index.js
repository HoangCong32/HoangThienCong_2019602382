var productCategoryController = function () {
    ...
    function registerEvents() {
        ...
        $("#fileInputImage").on('change', function () {
            ...
            $.ajax({
                ...
                success: function (path) {
                    $('#txtImage').val(path);
                    webbansach.notify('Tải hình ảnh danh mục thành công!', 'success');

                },
                error: function () {
                    webbansach.notify('Có lỗi khi tải ảnh!', 'error');
                }
            });
        });
        ...
        $('body').on('click', '#btnDelete', function (e) {
            e.preventDefault();
            var that = $('#hidIdM').val();
            webbansach.confirm('Bạn có muốn xóa danh mục?', function () {
                $.ajax({
                    type: "POST",
                    ...
                    success: function (response) {
                        webbansach.notify('Xóa danh mục thành công', 'success');
                        webbansach.stopLoading();
                        loadData();
                    },
                    error: function (status) {
        ...
        $('#btnSave').on('click', function (e) {
            if ($('#frmMaintainance').valid()) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        webbansach.notify('Cập nhật danh mục thành công', 'success');
    ...
    function loadData() {
        $.ajax({
            ...
            success: function (response) {
                ...
                var treeArr = webbansach.unflattern(data);
